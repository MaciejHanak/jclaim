...
//    public static final Color GROUP = Color.YELLOW;
    ...
    private final static Color COLOR_SELECTED = new Color(127, 127, 240);
    ...
    public static final int B_WIDTH  = 11; // always odd
...
//        g2d.drawLine(0,getHeight()-2, getWidth(), getHeight()-2);
        ...
        // Get Ready to draw everything on it.
        g.translate(ContactLabel.SIZE_WIDTH_INC/2, ContactLabel.SIZE_HEIGHT_INC/2);
        Graphics2D g2 = (Graphics2D) g.create();

        super.paintComponent(g);
        
        //shift the image for buttons
        g2.translate(getWidth() - B_WIDTH - ContactLabel.SIZE_WIDTH_INC, 5); // position painter
